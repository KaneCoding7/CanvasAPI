...
async function getRefProfile(requestedUsername, loggedInUser) {
  ...
  if (loggedInUser.username !== requestedUsername) {
    return utils.buildResponse(403, {
      message: "Forbidden: You cannot access another user's referee profile.",
    });
  }
...
module.exports.getRefProfile = getRefProfile;
